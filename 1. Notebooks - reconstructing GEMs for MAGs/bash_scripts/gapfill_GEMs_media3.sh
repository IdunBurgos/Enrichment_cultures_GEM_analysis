...
do
    ...
    then
        ...
        gapfill ../output/GEMs/GEMs_intermediate/GEMs_ACt2r/${filename:44:-4}.xml -o ../output/GEMs/GEMs_final3/${filename:44:-4}.xml -m ${community_id} --mediadb ../output/gapfill_media/gapfill_media.tsv --fbc2 --verbose 
    fi
done
